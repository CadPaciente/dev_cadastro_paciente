'''
MELHORIAS NA FUNÇÃO INSERIR DADOS
'''
...
class Funcoes():
    def limpar_campos(self):
        ...
        self.entry_idade2.place(x=953, y=160, width=80, height=28)
...
# Data Formatada
    ...
    def mostra_idade(self):
            try:
                ...
                self.entry_idade.place(x=950, y=160, width=75, height=27)


                self.entry_idade1 = Label(self.root, bg=self.lb_bg, fg='red', text='anos', font=('arial', 15, 'bold'))
                self.entry_idade1.place(x=975, y=160, width=75, height=27)
