'''
CRIAR O BANCO DE DADOS, TABELA, CRIAR  FUNÇÃO INSERIR DADOS, CAPTURAR DADOS INSERIDOS E LIMPAR CAMPOS DE DADOS
'''
...
# Data Formatada
    ...
    def mostra_idade(self):
            try:
                ...
                self.entry_idade = Label(self.root, bg=self.lb_bg, fg='red', text=f'{self.idade} anos', font=('arial', 15, 'bold'))
