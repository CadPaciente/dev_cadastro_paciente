...
# Data Local
        self.dia_atual1 = (datetime.today().strftime('Goiânia, %d de %B de %Y'))
        self.hj = Label(self.root, text=f'{self.dia_atual1}', bg=self.lb_bg, fg=self.lb_fg, font=('arail', 10, 'bold'))
