'''
FUNÇÃO  BOTÃO AGENDAMENTO - PARTE 2
'''
...
class Funcoes():
    ...
    def widgets_root3(self):
        ...
        self.bt_marcar = Button(self.root3, text='MARCAR', command=self.inserir_marcar_consultas)
        self.bt_marcar.place(x=198, y=270, width=80, height=25)


        self.bt_desmarcar = Button(self.root3, text='DESMARCAR', command='')
        self.bt_desmarcar.place(x=290, y=270, width=80, height=25)


        self.bt_buscar = Button(self.root3, text='BUSCAR', command='')
        self.bt_buscar.place(x=382, y=270, width=80, height=25)

        self.deletar_db = PhotoImage(file='agendamento7.png')
        ...
        self.bt_deletar_db = Button(self.root3, image=self.deletar_db, bd=0, bg='#001500', highlightthickness=0, command='', relief=FLAT )
